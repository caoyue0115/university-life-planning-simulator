...
N40 输入读取成功标志、N16/model_valid/requested_action/confirm_allowed/cancel_allowed/display_reply，以及 N18/N21/N23/N28/N30/N32/N34/N36 的执行结果。未执行路线按空值。
...
`prerequisites_ok` 在 N40 前用一个代码节点合并 N01/N05/N09/N11 的 isSuccess 与 N03/has_profile、N07/has_recommendation。输出只声明 `result_json:String`；N41 只返回该参数。
